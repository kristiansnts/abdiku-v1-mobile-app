export const translations = {
  en: {
    ...
    payslip: {
      ...
      selectPeriod: 'Select Statement Period',
      netPay: 'Take Home Pay',
      grossPay: 'Gross Pay',
      deductions: 'Deductions',
      earnings: 'Earnings & Additions',
      attendanceSummary: 'Attendance Summary',
      daysWorked: 'Days Worked',
      statementDate: 'Statement Date',
      period: 'Period',
      noData: 'No pay statements found',
      ...
      breakdown: {
        hadir: 'Present',
        terlambat: 'Late',
        cuti_dibayar: 'Paid Leave',
        cuti_tidak_dibayar: 'Unpaid Leave',
        sakit_dibayar: 'Paid Sick',
        sakit_tidak_dibayar: 'Unpaid Sick',
        libur_dibayar: 'Paid Holiday',
        libur_tidak_dibayar: 'Unpaid Holiday',
        absen: 'Absent',
      },
    },
    // Login Screen
  ...
  id: {
    ...
    payslip: {
      title: 'Slip Gaji',
      selectPeriod: 'Pilih Periode Gaji',
      netPay: 'Gaji Bersih (THP)',
      grossPay: 'Gaji Kotor',
      deductions: 'Potongan',
      earnings: 'Penghasilan & Tambahan',
      attendanceSummary: 'Ringkasan Kehadiran',
      daysWorked: 'Hari Kerja',
      statementDate: 'Tanggal Cetak',
      period: 'Periode',
      noData: 'Slip gaji tidak ditemukan',
      backToList: 'Kembali ke Daftar',
      employeeAmount: 'Karyawan',
      employerAmount: 'Perusahaan',
      summary: 'Ringkasan',
      attendanceRate: 'Tingkat Kehadiran',
      payableDays: 'Hari Dibayar',
      totalWorkingDays: 'Hari Kerja',
      totalAdditions: 'Total Tambahan',
      ...
      breakdown: {
        hadir: 'Hadir',
        terlambat: 'Terlambat',
        cuti_dibayar: 'Cuti Dibayar',
        cuti_tidak_dibayar: 'Cuti Tdk Dibayar',
        sakit_dibayar: 'Sakit Dibayar',
        sakit_tidak_dibayar: 'Sakit Tdk Dibayar',
        libur_dibayar: 'Libur Dibayar',
        libur_tidak_dibayar: 'Libur Tdk Dibayar',
        absen: 'Mangkir',
      },
    },
    // Login Screen
